...
class SudokuTest {
    ...
    public void testSudoku () {
        ...
        int[][] boardSolution = {{8, 7, 5, 2, 4, 9, 6, 1, 3},
                                {4, 9, 1, 7, 6, 3, 8, 5, 2},
                                {6, 3, 2, 5, 1, 8, 7, 4, 9},
                                {3, 1, 6, 9, 8, 7, 4, 2, 5},
                                {7, 2, 4, 1, 5, 6, 3, 9, 8},
        ...
        sudoku.solve();
        Sudoku sudokuSolved = new Sudoku(boardSolution);

        assertEquals(sudokuSolved.toString(), sudoku.toString());
    }
}
